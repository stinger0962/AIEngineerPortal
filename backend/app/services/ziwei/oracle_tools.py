...
VALID_PALACES = {"命宫", "兄弟", "夫妻", "子女", "财帛", "疾厄", "迁移", "交友", "仆役", "官禄", "田宅", "福德", "父母"}

# iztro 命盘用「仆役」；模型可能说「交友」，归一化到命盘实际宫名
_PALACE_ALIAS: dict[str, str] = {"交友": "仆役"}
...
TOOL_SCHEMAS: list[dict] = [
    {
        ...
        "input_schema": {
            "type": "object",
            "properties": {"palace": {"type": "string", "description": "宫位名，如 命宫、官禄、夫妻、仆役"}},
            "required": ["palace"],
        },
    },
    {
...
def execute_tool(name: str, tool_input: dict) -> dict:
    ...
    if name == "focus_palace":
        ...
        canonical = _PALACE_ALIAS.get(palace, palace)
        return {"ok": True, "command": {"type": "focus_palace", "palace": canonical}}
    if name == "overview":
