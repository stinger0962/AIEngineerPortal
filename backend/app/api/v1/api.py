...
from app.api.v1.routes import adaptive, ai_feedback, billing, copilot, courses, critique, dashboard, deep_dives, dub, exercise_variations, exercises, interview, interview_coaching, jobs, knowledge, korean, learning, live_jobs, memory, news, podcast, projects, qian, recommendations, resume, scribe, streaks, summary, ziwei
...
api_router.include_router(korean.router)
